# Generated by Django 4.2.3 on 2023-11-09 23:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.CharField(choices=[('d', 'پیش نویس'), ('p', 'منتشر شده'), ('i', 'درحال بررسی'), ('b', 'برگشت داده شده')], max_length=100, verbose_name='وضعیت')),
